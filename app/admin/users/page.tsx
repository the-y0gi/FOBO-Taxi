...
//     try {
//       const response = await adminService.users.getUsers({ search });
...
//     try {
//       await adminService.users.updateUserStatus(id, { isBlocked: !currentStatus });
//       // Update local state
//       setUsers(prev =>
//         prev.map(u =>
...
//                     <div>
//                       <p className="font-medium text-gray-900">{user.name}</p>
//                       <p className="text-xs text-gray-500">{user.id.slice(-6)}</p>
//                     </div>
//                   </div>
//                 </td>
