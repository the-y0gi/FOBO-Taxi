...
// import { MapPin, Navigation, Clock, Car, IndianRupee } from "lucide-react";
// import { adminService } from "@/api/adminService";

// export function UserHistory({ user }) {
...
//     try {
//       const response = await adminService.users.getUserHistory(userId);
...
//       <div className="space-y-3">
//         {[1, 2, 3].map((item) => (
//           <div key={item} className="animate-pulse bg-gray-200 rounded-xl p-3 h-32"></div>
//         ))}
//       </div>
//     );
//   }
