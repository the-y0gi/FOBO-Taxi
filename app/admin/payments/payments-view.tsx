...
//     try {
//       const response = await adminService.payments.getPayments({ page, limit: 10 });
...
//           <div className="sm:hidden space-y-3">
//             {payments.map((payment) => (
//               <Card key={payment.id} className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50/50 transition-colors">
//                 <div className="space-y-3">
//                   {/* Header - Payment ID and Amount */}
//                   <div className="flex justify-between items-start">
//                     <div>
//                       <p className="font-semibold text-gray-900 text-sm">Payment ID</p>
//                       <p className="font-medium text-gray-700">{payment.paymentId}</p>
//                     </div>
//                     <div className="flex items-center gap-1 font-semibold text-green-700">
//                       <IndianRupee className="w-3 h-3" />
//                       <span>₹{payment.amount}</span>
...
//                     </div>
//                     <div>
//                       <p className="font-semibold text-gray-900 text-sm mb-1">Driver</p>
//                       <div className="bg-gray-50 rounded-lg p-2">
//                         <p className="text-gray-700 text-sm">{payment.driver}</p>
//                       </div>
//                     </div>
...
//                   <div className="grid grid-cols-2 gap-3">
//                     <div>
//                       <p className="font-semibold text-gray-900 text-sm mb-1">Trip ID</p>
//                       <div className="bg-gray-50 rounded-lg p-2">
//                         <p className="text-gray-700 text-sm">{payment.tripId}</p>
//                       </div>
//                     </div>
//                     <div>
//                       <p className="font-semibold text-gray-900 text-sm mb-1">Mode</p>
//                       <Badge variant="outline" className="bg-blue-50 text-blue-700 border-blue-200 w-full justify-center">
//                         {payment.mode}
//                       </Badge>
//                     </div>
...
//           <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mt-4 sm:mt-6 pt-4 border-t border-gray-200">
//             <p className="text-sm text-gray-600 text-center sm:text-left">
//               Showing {(currentPage - 1) * 10 + 1}-{Math.min(currentPage * 10, pagination.total)} of {pagination.total} payments
//             </p>
//             <div className="flex gap-2 justify-center sm:justify-end">
//               <Button 
//                 variant="outline" 
