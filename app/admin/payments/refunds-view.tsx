...
//     try {
//       const response = await adminService.payments.getRefunds();
...
//     try {
//       await adminService.payments.processRefund(id);
//       // Update local state
//       setRefunds(prev =>
//         prev.map(r =>
//           r.id === id ? { ...r, status: "processed" } : r
...
//             <RefreshCw className="w-4 h-4 sm:w-5 sm:h-5 text-primary" />
//             <div>
//               <h3 className="text-base sm:text-lg font-semibold text-gray-900">Refund Center</h3>
//               <p className="text-sm text-gray-500 mt-1">Manage and process refund requests</p>
//             </div>
//           </div>
...
//                     <TableCell className="font-medium text-gray-900">{refund.id}</TableCell>
...
//           <div className="sm:hidden space-y-3">
//             {refunds.map((refund) => (
//               <Card key={refund.id} className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50/50 transition-colors">
//                 <div className="space-y-3">
//                   {/* Header - Refund ID and Amount */}
//                   <div className="flex justify-between items-start">
//                     <div>
//                       <p className="font-semibold text-gray-900 text-sm">Refund ID</p>
//                       <p className="font-medium text-gray-700">{refund.id}</p>
//                     </div>
//                     <div className="flex items-center gap-1 font-semibold text-red-700">
//                       <IndianRupee className="w-3 h-3" />
//                       <span>₹{refund.amount}</span>
